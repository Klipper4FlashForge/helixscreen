...
them holds. Each widget listed here is a place that relies on that, and before
lv_xml_bind_compose each was a place where the outcome depended on which subject
notified last.
