...
static std::vector<PanelWidgetDef> s_widget_defs = {
    ...
    {"printer_image",    TR_NOOP("Printer Image"),    "rotate_3d",        TR_NOOP("A picture of your printer"),                    "Printer Image",    nullptr,              nullptr,                               CAT_PRINT,    true,  4, 4, 2, 2, 8, 6, false, true, true, false},
    {"print_status",     TR_NOOP("Print Status"),     "printer_3d",       TR_NOOP("Progress, file, and time remaining"),           "Print Status",     nullptr,              nullptr,                               CAT_PRINT,    true,  4, 4, 4, 2, BAND_COLSPAN, 6, false, true, true, false},
    ...
    {"tool_switcher",    TR_NOOP("Tool Switcher"),     "arrow_left_right", TR_NOOP("Switch the active tool or extruder"),            "Tool Switcher",    nullptr,              nullptr,                               CAT_CONTROLS, false, 2, 2, 2, 2, 4, 4, false, true, true},
    ...
    {"fan_stack",        TR_NOOP("Fan Speeds"),        "fan",              TR_NOOP("Part, hotend, and auxiliary fan speeds"),        "Fan Speeds",       nullptr,              nullptr,                               CAT_TEMP,     true,  2, 2, 2, 2, 6, 4, true, true, true},
    {"fan",              TR_NOOP("Fan"),               "fan",              TR_NOOP("The speed of one fan you choose"),              "Fan",              nullptr,              nullptr,                               CAT_TEMP,     false, 2, 2, 2, 2, 4, 2, true, true, false},
    ...
    {"nozzle_temps",     TR_NOOP("Nozzle Temperatures"),"thermometer",      TR_NOOP("Every extruder's temperature at once"),          "Nozzle Temperatures", nullptr,           nullptr,                               CAT_TEMP,     false, 2, 4, 2, 2, 4, 6, false, true, true, false},
    ...
    {"temp_stack",       TR_NOOP("Temperatures"),      "thermometer",      TR_NOOP("Nozzle, bed, and chamber in one widget"),       "Temperatures",     nullptr,              nullptr,                               CAT_TEMP,     false, 2, 2, 2, 2, 6, 4, false, true, true},
    {"thermistor",       TR_NOOP("Temperature Sensors"), "thermometer",    TR_NOOP("Readings from extra temperature sensors"),          "Temperature Sensors", "temp_sensor_count", "No temperature sensors detected", CAT_TEMP,     false, 2, 2, 2, 2, 4, 2, true, true, false},
    {"temp_graph",       TR_NOOP("Temperature Graph"), "chart_line",       TR_NOOP("Temperatures plotted over time"),                   "Temperature Graph", nullptr,         nullptr,                               CAT_TEMP,     false, 4, 4, 2, 2, BAND_COLSPAN, 8, true, true, true, false},
    {"preheat",          TR_NOOP("Preheat"),           "heat_wave",        TR_NOOP("Warm up for a material in one tap"),            "Preheat",            nullptr,            nullptr,                               CAT_TEMP,     false, 6, 2, 4, 2, 8, 2, false, true, false},
    {"ams",              TR_NOOP("Multi-Filament System Status"),        "filament",         TR_NOOP("Lane colors, materials, and levels"),                  "AMS Status",       "ams_slot_count",     "Requires Multi-Filament System or MMU hardware",        CAT_FILAMENT, false, 2, 2, 2, 2, 8, 4, false, true, true},
    {"active_spool",     TR_NOOP("Active Spool"),      "inventory",  TR_NOOP("The Spoolman spool currently loaded"),          "Active Spool",     nullptr,                  nullptr,                           CAT_FILAMENT, false, 2, 2, 2, 2, 8, 4, false, true, true},
    ...
    {"favorite_macro", TR_NOOP("Macro Button"),    "play",             TR_NOOP("Run a macro you choose, in one tap"),           "Macro Button",     nullptr,              nullptr,                               CAT_CONTROLS, false, 2, 2, 2, 2, 4, 2, true, true, false},
    ...
    {"job_queue",        TR_NOOP("Job Queue"),         "progress_clock",   TR_NOOP("Print jobs waiting to run"),                   "Job Queue",        nullptr,              nullptr,                               CAT_PRINT,    false, 4, 4, 4, 2, 8, 6, false, true, true},
    //                                                                                                                                          hint                                cat              en  col row min_c min_r max_c max_r  multi  half_c half_r merges_card
...
#if HELIX_HAS_CAMERA
    {"camera",           TR_NOOP("Camera"),            "video",            TR_NOOP("Live view from your webcam"),                   "Camera",           nullptr,              nullptr,                               CAT_PRINT,    false, 4, 4, 2, 2, 8, 6, false, true, true, false},
#endif
