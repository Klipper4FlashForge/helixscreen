...
static std::vector<PanelWidgetDef> s_widget_defs = {
    ...
    {"shutdown",         "Shutdown/Reboot",   "power",            "Shutdown or reboot the printer host",          "Shutdown/Reboot",  nullptr,              nullptr,                               false, 2, 2, 1, 2, 2, 2, false, true, false},
    {"lock",             "Lock Screen",       "lock",             "PIN-protected screen lock",                    "Lock Screen",      nullptr,              nullptr,                               false, 2, 2, 1, 2, 2, 2, false, true, false},
    ...
    {"firmware_restart", "Firmware Restart",  "refresh",          "Restart Klipper firmware",                     "Firmware Restart", nullptr,              nullptr,                               false, 2, 2, 1, 2, 2, 2, false, true, false},
    ...
    {"led_controls",     "LED Controls",      "led_strip",        "Open LED color and brightness controls",       "LED Controls",     "led_controllable",   "No LED strips detected",              false, 2, 2, 1, 2, 2, 2, false, true, false},
    ...
    {"nozzle_temps",     "Nozzle Temperatures","thermometer",      "All extruder temperatures with progress bars",  "Nozzle Temperatures", nullptr,           nullptr,                               false, 2, 4, 2, 2, 4, 6},
    {"bed_temperature",  "Bed Temperature",   "radiator",         "Monitor and set bed temperature",              "Bed Temperature",    nullptr,            nullptr,                               false, 2, 2, 2, 2, 4, 4},
    ...
    {"clock",            "Digital Clock",     "clock",            "Current time and date",                       "Digital Clock",    nullptr,              nullptr,                               false, 4, 2, 1, 1, 6, 6, false, true, true},
...
#if HELIX_HAS_CAMERA
    {"camera",           "Camera",            "video",            "Live webcam feed",                             "Camera",           nullptr,              nullptr,                               false, 4, 4, 2, 2, 8, 6},
#endif
