...
- **Max 4 on-device install untested** -- Detection heuristics use the stock Max 4 config shape, but display and touch rendering still need community validation.
