...
- `../ARCHITECTURE.md` § "Centralized Temperature Sends" — full TemperatureController behavior (M141, SendOptions, presets); § "ToolState" for the ToolInfo struct.
