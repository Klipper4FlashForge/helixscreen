...
class PluginManager {
  public:
     ...
     */
    void set_core_services(MoonrakerAPI* api, IMoonrakerClient* client, PrinterState& state,
                           Config* config);
     ...
     */
    void update_moonraker_services(MoonrakerAPI* api, IMoonrakerClient* client);
